      ...
      <SettingsSection id="download-source" title="模型下载源">
        ...
        {draft.download_source === 'huggingface' ? (
          <>
            ...
            <SettingsField
              label="endpoint"
              helpTooltip={<p>模型下载端点。默认 HuggingFace 官方源。需要镜像 / 自建反代时选「自定义 URL」粘贴。</p>}
            >
              <HFEndpointSelect
...
const HF_ENDPOINT_PRESETS: { value: string; label: string; hint: string }[] = [
  { value: '', label: 'huggingface.co', hint: '官方源（默认）' },
  { value: '__custom__', label: '自定义 URL...', hint: '粘贴自建反代 / sjtug / 腾讯镜像等' },
]
